...
const services = [
  ...
  { pageName: 'Stone',
    ...
    title: 'Stone',
    summary: 'Stone refacing has become a popular way to enhance the exterior beauty of your home using stone products. Real stone refacing allows us to change the look of your home through custom stone renovations eliminating the need to move away from your existing neighbourhood while achieving an updated look for your home or business.',
    subtitle1: 'Excellent Craftsmanship',
  ...
  { pageName: 'Walls',
    ...
    title: 'Walls & Windows',
    summary: 'Properly installed window sills are essential for the complete building envelope. Brick window sills tend to breakdown for a number of reasons. They are installed with an insufficient slope downwards and water sits on the brick instead of flowing away from the window. There are so many mortar joints and therefore too many possible entries for water to penetrate.',
    subtitle1: 'Excellent Craftsmanship',
  ...
  { pageName: 'Basement',
    ...
    title: 'Basement',
    summary: 'With basement waterproofing, usually we have to excavate the problem area or areas right down to the footing. We then check the weeping tile to make sure that after we leave the area that it is in good shape. If it too is defective, we must repair it.',
    subtitle1: 'Excellent Craftsmanship',
